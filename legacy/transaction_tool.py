...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', '--to', help='target of transaction')
    parser.add_argument('-m', '--message', help='message of transaction')
    ...
    transaction = sign_transaction(public_key, private_key, {"to": target, "message": message})
    # if transaction:
    #     print("------transaction------")
